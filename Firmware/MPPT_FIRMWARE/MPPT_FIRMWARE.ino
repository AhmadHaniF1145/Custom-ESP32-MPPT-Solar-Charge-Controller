String
  firmwareInfo = "V1.0    ",
  firmwareDate = "16/12/24",
  firmwareContactR1 = "www.linkedin.com/in/ahmadhanif114",
  firmwareContactR2 = "/in/ahmadhanif114";
...
#define WIFI_RECONNECT_INTERVAL 3000  // Interval reconnect WiFi dalam ms

// Firebase
#define WIFI_SSID "ACW_Utama"
#define WIFI_PASSWORD "Acw51111"
#define API_KEY "AIzaSyCiFGt3kUVidq3MWIzSyjD7CZ9xjxj3jJE"
#define DATABASE_URL "https://mppt-iot-default-rtdb.asia-southeast1.firebasedatabase.app/"
#define USER_EMAIL "abiyyukhrisna@gmail.com"
#define USER_PASSWORD "Adiyatma2"
...
float
  ...
  electricalPrice = 2.000;      //   USER PARAMETER - Input electrical price per kWh (Dollar/kWh,Euro/kWh,Peso/kWh,Rp/kWh)
...
int
  ...
  avgCountTS = 5;      //  CALIB PARAMETER - Temperature Sensor Average Sampling Count
float
  inVoltageDivRatio = 41.46183,   //  CALIB PARAMETER - Input voltage divider sensor ratio (change this value to calibrate voltage sensor)
  outVoltageDivRatio = 24.56713,  //  CALIB PARAMETER - Output voltage divider sensor ratio (change this value to calibrate voltage sensor)
  vOutSystemMax = 50.0000,        //  CALIB PARAMETER -
  cOutSystemMax = 50.0000,        //  CALIB PARAMETER -
  ntcResistance = 8000.00,        //  CALIB PARAMETER - NTC temp sensor's resistance. Change to 10000.00 if you are using a 10k NTC
  ...
  currentInAbsolute = 30.0000,    //  CALIB PARAMETER - Maximum Input Current The System Can Handle (A - Input)
...
bool
  ...
  buttonRightStatus = 1,    // SYSTEM PARAMETER -
  buttonLeftStatus = 1,     // SYSTEM PARAMETER -
  buttonBackStatus = 1,     // SYSTEM PARAMETER -
  buttonSelectStatus = 1,   // SYSTEM PARAMETER -
  buttonRightCommand = 1,   // SYSTEM PARAMETER -
  buttonLeftCommand = 1,    // SYSTEM PARAMETER -
  buttonBackCommand = 1,    // SYSTEM PARAMETER -
  buttonSelectCommand = 1,  // SYSTEM PARAMETER -
